    ...
    return (
        <> <div className="flex flex-wrap justify-center mb-9 w-6/6">
            ...
            <div className='flex justify-center  mb-20  overflow-hidden '>
                <div className='project-1  flex border border-sky-600 border-2 max-w-4xl items-center height:  bg-zinc-300 pr-20 py-36 rounded-md
        ...
        />
                    <div className='flex-col'>
                        <div>
                        <h1 className= 'h1-exp  text-5xl py-4 text-blue-600 basis-1/2'>Projects</h1>
                        <div className='project-data py-5'>
                            <span className='gepto-1 text-2xl text-red-700'>Photo Website: </span><br/>
                            ...
                            <br/> <span className='gepto-1 text-2xl text-red-700'> Profile Page:</span> <br/>
                          ...
                          <br/> <span className= 'gepto-1 text-2xl text-red-700' >Comparing PC Parts: </span>  <br/>
