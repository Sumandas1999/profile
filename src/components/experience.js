    ...
    return (
        ...
        />
                    <div className='flex-col '>
                        <h1 className='text-5xl py-4 text-blue-600 basis-1/2'>Experience</h1>
                        <div className='py-5'><span className='text-red-700 text-2xl '> Web Development Odyssey at</span>  <span className='text-2xl text-blue-700 underline underline-offset-4  '><a href='https://gepton.com/'>Gepton</a> </span>
